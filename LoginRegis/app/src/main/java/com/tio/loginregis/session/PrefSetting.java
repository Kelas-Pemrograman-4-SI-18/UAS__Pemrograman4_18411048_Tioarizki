package com.tio.loginregis.session;
...
import com.tio.loginregis.pembeli.HomePembeli;
...
public class PrefSetting {
    ...
    public void storeRegIdSharePreference(Context context, String _id, String userName, String namaLengkap,
